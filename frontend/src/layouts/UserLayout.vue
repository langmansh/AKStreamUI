  ...
  <div id="userLayout" :class="['user-layout-wrapper', device]">
    <div class="container">
      <div class="top">
        <div class="header">
          <a href="/">
            ...
            <span class="title">AKStream流媒体管理系统</span>
          </a>
        </div>
        <div class="desc">
      ...
      <div class="footer">
        ...
        <div class="copyright">
          Copyright © 2021 <a target="_blank" href="https://gitee.com/sscboshi/AKStreamWebUI">AKStreamWebUI</a> All rights reserved. v1.0.0
        </div>
      </div>
    </div>
  </div>
